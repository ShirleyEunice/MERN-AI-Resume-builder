...
const ClassicTemplate = ({ data, accentColor }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-5 py-6 sm:p-8 bg-white text-gray-800 leading-relaxed">
      
      {/* Header */}
      <header
        className="text-center mb-6 sm:mb-8 pb-5 sm:pb-6 border-b-2"
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-xs sm:text-sm text-gray-600 break-words">
      ...
      {data.experience?.length > 0 && (
        <section className="mb-6">
          <h2 className="text-lg sm:text-xl font-semibold mb-4" style={{ color: accentColor }}>
        ...
        <section className="mb-6">
          ...
          <div className="space-y-4">
            {data.projects.map((proj, index) => (
              <div key={index} className="border-l-4 pl-4 border-gray-300">
