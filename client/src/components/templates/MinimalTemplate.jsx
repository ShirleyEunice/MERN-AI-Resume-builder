const MinimalTemplate = ({ data, accentColor }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-5 py-6 sm:p-8 bg-white text-gray-900 font-light">
      
      {/* Header */}
      <header className="mb-8 sm:mb-10">
        <h1 className="text-3xl sm:text-4xl font-thin mb-4 tracking-wide">
          {data.personal_info?.full_name || "Your Name"}
        </h1>

        <div className="flex flex-wrap gap-x-5 gap-y-2 text-xs sm:text-sm text-gray-600 break-words">
      ...
      {data.experience?.length > 0 && (
        <section className="mb-8 sm:mb-10">
          <h2
            className="text-xs sm:text-sm uppercase tracking-widest mb-5 sm:mb-6 font-medium"
