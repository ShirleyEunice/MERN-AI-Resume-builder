      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          >
            ...
            bg-linear-to-r from-indigo-300 to-indigo-500 text-white rounded-full"
            />
          ...
          <button
            ...
            className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg
          gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-purple-500 hover:shadow-lg transition-all duration-300 cursor-pointer"
          >
            <UploadCloudIcon
              className="size-11 transition-all duration-300 p-2.5
            bg-linear-to-r from-purple-300 to-purple-500 text-white rounded-full"
            />
          ...
          {allResumes.map((resume, index) => {
            ...
            justify-center rounded-lg gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer"
              ...
              >
                ...
                <div onClick={e => e.stopPropagation()} className="absolute top-1 right-1 items-center hidden group-hover:flex sm:flex">
                  <Trash onClick={()=> deleteResume(resume._id)} className="size-7 p-1.5 hover:bg-white/50 rounded text-red-500 transition-colors" />
          ...
          >
            ...
            >
              ...
              <input
                ...
                value={title}
                className="w-full px-4 py-2 mb-2 focus:border-green-600 ring-green-600"
                required
              />
            ...
            >
              ...
              <div>
                <label
                  ...
                  className="bloack text-sm text-slate-700"
                >
                  Select resume file
                  <div
